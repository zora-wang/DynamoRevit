...
namespace Revit.Elements
{
    ...
    /// </summary>
    [RegisterForTrace]
    public class InvisibleImportInstance : Element
    {
        [Browsable(false)]
        ...
        internal InvisibleImportInstance(string satPath, XYZ translation = null)
        {
            ...
            Document.ActiveView.HideElements(new ElementId[] { id });
        ...
        /// <returns></returns>
        public static InvisibleImportInstance BySATFile(string pathToFile)
        {
            ...
            return new InvisibleImportInstance(pathToFile);
        }
        ...
        /// <returns></returns>
        public static InvisibleImportInstance ByGeometries(Autodesk.DesignScript.Geometry.Geometry[] geometries)
        {
            if (geometries == null)
            {
            ...
            return new InvisibleImportInstance(exported_fn, translation.ToXyz());
        }
        ...
        /// <returns></returns>
        public static InvisibleImportInstance ByGeometry(Autodesk.DesignScript.Geometry.Geometry geometry)
        {
            if (geometry == null)
            {
